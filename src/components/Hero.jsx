...
const Hero = () => {
  return (
    <section className="flex flex-col items-center justify-center text-center pt-32 pb-10 bg-[#0d1117] text-white px-4">
      ...
      >
        Apprenti Ingénieur DevOps | Développeuse Backend
      </Reveal>
    </section>
  );
};
